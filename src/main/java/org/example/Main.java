...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "berkay", "yılmaz"));
        employees.add(new Employee(1, "berkay", "yılmaz"));
        employees.add(new Employee(1, "berkay", "yılmaz"));
        employees.add(new Employee(2, "aylin", "türk"));
        employees.add(new Employee(2, "aylin", "türk"));
        employees.add(new Employee(3, "cemil", "kaya"));
        employees.add(new Employee(4, "suat", "yıldız"));
        employees.add(new Employee(5, "cevat", "sönmez"));
